...
<head>
    ...
    <meta name="description"
        content="This is an example dashboard (DiabloWatch) created using build-in elements and components.">
                                ...
                                <div class="widget-content-left">
                                    <div class="btn-group">
                                        <a data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"
                                            class="p-0 btn">
                                            <img width="42" class="rounded-circle" src="front/img/avatar/{{ Auth::user()->avatar ?? 'default-avatar.png' }}"
                                                alt="">
                                                            ...
                                                            <div class="widget-content-wrapper">
                                                                <div class="widget-content-left mr-3">
                                                                    <img width="42" class="rounded-circle"
                                                                        src="front/img/avatar/{{ Auth::user()->avatar ?? 'default-avatar.png' }}" alt="">
                                                                </div>
                                                                <div class="widget-content-left">
                                                                ...
                                                                <div class="widget-content-right mr-2">
                                                                    <a href="./admin/logout" class="btn-pill btn-shadow btn-shine btn btn-focus">Logout
                                                                    </a>
                                                                </div>
                                                            </div>
                                                        </div>
